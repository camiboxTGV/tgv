...
const FIXTURES: Fixture[] = [
  {
    ...
    slugPath: "drinkware/mugs-and-cups/ceramic-mugs",
    price: 1.85,
    stock: 420,
    images: [],
    material: ["CERAMIC"],
  ...
  },
  {
    ...
    slugPath: "drinkware/bottles/thermal-and-vacuum-flasks",
    price: 8.4,
    stock: 38,
    images: [],
  ...
  },
  {
    ...
    slugPath: "office-and-writing/notebooks-and-planners/notebooks",
    price: 4.2,
    stock: 6,
    images: [],
  ...
  },
  {
    ...
    slugPath: "office-and-writing/writing-instruments/ball-pens",
    price: 1.2,
    stock: 0,
    images: [],
    material: ["ALUMINIUM"],
