...
This project is indexed by GitNexus as **tgv-contact-cta** (2399 symbols, 4434 relationships, 207 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
